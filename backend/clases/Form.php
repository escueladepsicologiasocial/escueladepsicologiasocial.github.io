...
//
        ...
        public static function FormMenuCaja(){            
            $grilla="<div class='row'>
                        <div class='btn-group-vertical'>
                            <button type='button' id='btnApertura' onclick='Test.GenerarFormAperturaCaja()' class='btn btn-secondary  ' >Abrir</button>
                            <button type='button' id='btnEntrada' onclick='Test.GenerarFormEntradaDeCaja()' class='btn btn-secondary  ' disabled>Entrada</button>               
                            <button type='button' id='btnSalida' onclick='Test.GenerarFormSalidaDeCaja()' class='btn btn-secondary  ' disabled>Salida</button>
                            <button type='button' id='btnCierre' onclick='Test.CierreCaja()' class='btn btn-secondary' disabled>Cerrar</button>
                            <button type='button' id='btnActualizar' onclick='Test.GenerarActualizar()' class='btn btn-secondary  ' disabled>Actualizar</button>";
                        if(isset($_SESSION['perfil']) && ( $_SESSION['perfil']=='WebMaster' || $_SESSION['perfil']=='Jefe')){
            $grilla.=      "<button type='button' id='btnEstadistica' onclick='Test.Estadisticas()' class='btn btn-secondary  '>Estadisticas</button>";
                        }              
            $grilla.=      "</div>                                    
                    </div>";
            return $grilla;
