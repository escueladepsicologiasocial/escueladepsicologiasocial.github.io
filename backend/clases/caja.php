...
/******************************************************************************************************* */
        ...
        public static function generarFormAperturaCaja(){
            $form=  "<br>
                <div class='container opacidad '>
                    <div class='p-3 mb-2 bg-secondary text-white rounded container fullWidth'>
                        <div class='input-group row'>
                            <div class='col-8' >
                    ...
                    <div class='form-row'>
                        ...
                        <div class='form-group col-md-4'>
                            ...
                            <textarea  type='textarea' class='form-control' id='textAreaDetalle' placeholder=':detalle'></textarea>
                        </div>
                        <div class='form-group col-md-4' hidden>
        ...
        public static function TraerCajas(){
            ...
            $consulta->execute(); 
            return $consulta->fetchAll(PDO::FETCH_CLASS, "Caja"); //retorna caja abierta
        }
