...
///<reference path="../libs/jqueryTS/charts.d.ts"/>
var Test;
(function (Test) {
    /********************************************** GRILLAS *************************************************/
    ...
    function Estadisticas() {
        ...
        $.ajax({
            ...
            .done(function (objJSON) {
            var div = "<div class='col-md-5'><canvas id='myChart' width='400' height='400'></canvas>";
            div += "<script>";
            div += "var ctx = document.getElementById('myChart').getContext('2d');";
            div += "var myChart = new Chart(ctx, {";
            div += "type: 'bar',";
            div += "data: {";
            div += "labels: ['Red', 'Blue', 'Yellow', 'Green', 'Purple', 'Orange'],";
            div += "datasets: [{";
            div += "label: '# of Votes',";
            div += "data: [12, 19, 3, 5, 2, 3],";
            div += "backgroundColor: [";
            div += "'rgba(255, 99, 132, 0.2)',";
            div += "'rgba(54, 162, 235, 0.2)',";
            div += "'rgba(255, 206, 86, 0.2)',";
            div += "'rgba(75, 192, 192, 0.2)',";
            div += "'rgba(153, 102, 255, 0.2)',";
            div += "'rgba(255, 159, 64, 0.2)'";
            div += "],";
            div += "borderColor: [";
            div += "'rgba(255,99,132,1)',";
            div += "'rgba(54, 162, 235, 1)',";
            div += "'rgba(255, 206, 86, 1)',";
            div += "'rgba(75, 192, 192, 1)',";
            div += "'rgba(153, 102, 255, 1)',";
            div += "'rgba(255, 159, 64, 1)'";
            div += "],";
            div += "borderWidth: 1";
            div += "}]";
            div += "},";
