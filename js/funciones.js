...
(function (Test) {
    ...
    function formAltaUsuario() {
        var grilla = '<input type="text" id="idUsuario" name="idUsuario" style="visibility:hidden">';
    ...
    function formAltaAlumno() {
        var grilla = '<input type="text" id="idAlumno" name="idAlumno" style="visibility:hidden">';
        grilla += "<div class='container'>";
    ...
    function menuUsuarios() {
        $("#divResultado").html("");
        var grilla = "<div class='float-sm-left'>";
        grilla += "<div class='row'>";
    ...
    function modificarAlumno(id, idtr) {
        var pagina = "backend/a/";
        idtr = "tr" + idtr;
    ...
    Test.modificarAlumno = modificarAlumno;
    //    
})(Test || (Test = {}));
